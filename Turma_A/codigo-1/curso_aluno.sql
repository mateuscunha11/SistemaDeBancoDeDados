-- Active: 1787873484163@@127.0.0.1@5432@bd_aula@public
...
SELECT table_name, -- Nome Tabela
       column_name, -- Nome Coluna
       data_type, -- tipo de dado
       character_maximum_length AS tamanho, -- Tamanho Maximo de Texto
       is_nullable              AS aceita_nulo, -- Aceita Nulo
       is_identity              AS e_identidade -- Verifica se a coluna é criada automaticamente.
